<template>
	<div class="dropdown dropdown-bottom dropdown-end">
		<div tabindex="0" role="button" class="m-1">
			<svg class="drop-shadow-lg cursor-pointer hover:scale-110 transition-all duration-150 ease-in-out"
				v-if="lang === 'en' || !lang" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
				viewBox="0 0 32 32">
			...
			<svg class="drop-shadow-lg cursor-pointer hover:scale-110 transition-all duration-150 ease-in-out tooltip tooltip-bottom"
				data-tip="FR" v-if="lang === 'fr'" xmlns=" http://www.w3.org/2000/svg" width="32" height="32"
				viewBox="0 0 32 32">
			...
			<svg class="drop-shadow-lg cursor-pointer hover:scale-110 transition-all duration-150 ease-in-out tooltip tooltip-bottom"
				data-tip="DE" v-if="lang === 'de'" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
				viewBox="0 0 32 32">
			...
			<svg class="drop-shadow-lg cursor-pointer hover:scale-110 transition-all duration-150 ease-in-out tooltip tooltip-bottom"
				data-tip="ES" v-if="lang === 'es'" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
				viewBox="0 0 32 32">
